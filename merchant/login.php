...
$ses_sql=mysql_query("select username from admin_merchant where username='$user_check' ");
...
$sql="SELECT id FROM admin_merchant WHERE username='$myusername' and passcode='$mypassword'";
...
<script type="text/template" id="tt-tpl" charset="utf-8">
    ...
    <div id="header" data-as-version="10_6707430509" class="header-signed-out" data-as-extras="[]">
        ...
        <div id="navigation-group" class="clear" role="navigation">
                            ...
                            <li class="sign-in-link nav-item nav-item-sign-in">
                                <a href="/../login.php" title="Sign in to your Etsy account" id="sign-in" class="inline-overlay-trigger">
  ...
  Customer Login
							 ...
							 <li class="sign-in-link nav-item nav-item-sign-in">
                                <a href="#" id="sign-in" class="inline-overlay-trigger">
...
<body bgcolor="#FFFFFF">
<div align=left><h1>Merchant Login
</h1>
</div>
